...
CCScene* backgroundNext::scene()
{
    // 'scene' is an autorelease object
    CCScene *scene = CCScene::create();
    
    // 'layer' is an autorelease object
    backgroundNext *layer = backgroundNext::create();
...
bool backgroundNext::init()
{
    ...
    this->schedule(schedule_selector(backgroundNext::timer));
    
    this->schedule(schedule_selector(backgroundNext::hurdlesTimer));
    
    this->schedule(schedule_selector(backgroundNext::hurdlesTimerDown));
    
    this->schedule(schedule_selector(backgroundNext::hurdlesTimerUp));
    
    CCLabelTTF *labelp = CCLabelTTF::create("RESTART"," ARIAL", 20);
    CCMenuItemLabel *lab = CCMenuItemLabel::create(labelp, this, menu_selector(backgroundNext::restart));
...
void backgroundNext::createHurdles()
{
    ...
    CCFiniteTimeAction *callBack = CCCallFuncN::create(this,callfuncN_selector(backgroundNext::deleteHurdles));
...
void backgroundNext::createHurdlesDown()
{
    ...
    CCFiniteTimeAction *callBack1 = CCCallFuncN::create(this,callfuncN_selector(backgroundNext::deleteHurdlesDown));
    ...
    CCFiniteTimeAction *callBack2 = CCCallFuncN::create(this,callfuncN_selector(backgroundNext::deleteHurdlesDown));
...
void backgroundNext::reverseAction1()
{
...
//    CCFiniteTimeAction *callBack = CCCallFuncN::create(this,callfuncN_selector(backgroundNext::createHurdlesDown));
//     CCFiniteTimeAction *callBack1 = CCCallFuncN::create(this,callfuncN_selector(backgroundNext::deleteHurdlesDown));
//    
...
void backgroundNext::createHurdlesUp()
{
    ...
    CCFiniteTimeAction *callBack = CCCallFuncN::create(this,callfuncN_selector(backgroundNext::deleteHurdlesUp));
    ...
    CCFiniteTimeAction *callBack1 = CCCallFuncN::create(this,callfuncN_selector(backgroundNext::deleteHurdlesUp));
...
void backgroundNext::reverseAction()
{
...
//    CCFiniteTimeAction  *callBack1 = CCCallFuncN::create(this,callfuncN_selector(backgroundNext::deleteHurdlesUp));
//    CCFiniteTimeAction  *callBack2 = CCCallFuncN::create(this,callfuncN_selector(backgroundNext::createHurdlesUp));
...
void backgroundNext::hurdlesTimer()
{
    time++;
    if(time % 60 ==0)
    {
...
void backgroundNext::hurdlesTimerDown()
{
    timeDown++;
    if(timeDown % 80 ==0)
    {
...
void backgroundNext::hurdlesTimerUp()
{
    timeUp++;
    if(timeUp % 80 ==0)
    {
...
void backgroundNext::deleteHurdles(CCObject *sender)
{
...
void backgroundNext::deleteHurdlesDown(CCObject *sender)
{
...
void backgroundNext::deleteHurdlesUp(CCObject *sender)
{
...
void backgroundNext::restart()
{
    CCDirector::sharedDirector()->replaceScene(backgroundNext::scene());
}

void backgroundNext::replace()
{
   CCDirector::sharedDirector()->replaceScene(gameOver::scene());
}

void backgroundNext::timer()
{
    timeKeeper++;
    if(timeKeeper % 1 == 0)
    {
...
void backgroundNext::ccTouchesBegan(CCSet *pTouches, CCEvent *pEvent)
{
...
void backgroundNext::ccTouchesMoved(CCSet *pTouches, CCEvent *pEvent)
{
    CCTouch* touch = (CCTouch*)( pTouches->anyObject() );
    CCPoint location = touch->getLocationInView();
}

void backgroundNext::ccTouchesEnded(CCSet* touches, CCEvent* event)
{
