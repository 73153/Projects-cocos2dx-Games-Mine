...
//		CCLOG(@"Retina Display Not supported");
    ...
    [defaults setObject:nil forKey:@"profileDataArray" ];
	...
	// Run the intro Scene
       [[CCDirector sharedDirector] runWithScene: [CCTransitionMoveInR transitionWithDuration:.5 scene:[SXMainMenu  scene]]];
}
