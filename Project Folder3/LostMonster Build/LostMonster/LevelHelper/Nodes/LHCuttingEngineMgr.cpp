...
//    }
    ...
    LHSprite* newSprite1 = NULL;
    LHSprite* newSprite2 = NULL;
    
    if(body1 != NULL)
    {
        if (body1->GetFixtureList() != NULL) //we have no fixture in this body - lets dump it
        {
            newSprite1 = createNewSpriteFromBodyInfo(body1, oldSprite);
    ...
    if(body2 != NULL)
    {
        ...
        {
            newSprite2 = createNewSpriteFromBodyInfo(body2, oldSprite);
    ...
    LMDataManager::sharedManager()->gameLayer->splitedSprites(newSprite1, newSprite2);
...
//------------------------------------------------------------------------------
bool LHCuttingEngineMgr::cutSprite(LHSprite* oldSprite, CCPoint startPt, CCPoint endPt)
{
    bool didSlice = false;
...
//------------------------------------------------------------------------------
bool LHCuttingEngineMgr::cutAllSpritesWithTag(int tag,
                                              CCPoint startPt,
                                              CCPoint endPt,
                                              b2World* world){
    bool didSlice = false;
