...
bool HelloWorld::init()
{
    ...
    animationsTestNode = ccbReader->readNodeGraphFromFile("ClpaaingAndYesScene.ccbi", this);
    animationManager = ccbReader->getAnimationManager();
    animationsTestNode->setPosition(ccp(220,160));
...
{
//   animationManager->runAnimationsForSequenceNamed("DogClapping");
//    animationManager->runAnimationsForSequenceNamed("DogTryAgainAnimation");
