...
//               
                ...
                if(this->isPlayerSelectedXsprite)
                {
                  ...
                  CocosDenshion::SimpleAudioEngine::sharedEngine()->playEffect("okaytryagain.mp3");
                               
                //first
                CCAnimationCache *animCache1 = CCAnimationCache::sharedAnimationCache();
                CCAnimation *animation1 = animCache1->animationByName("DogNo");
                animation1->setRestoreOriginalFrame(1);
                CCAnimate *animN1 = CCAnimate::create(animation1);
                ...
                animation2->setRestoreOriginalFrame(1);
                CCAnimate *animN2 =CCAnimate::CCAnimate::create(animation2);
