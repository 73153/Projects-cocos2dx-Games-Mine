...
void BBMatchGamePlay::initializeGameUI() {
    ...
    dogAnim=CCSprite::createWithSpriteFrameName("clapping001.png");
    dogAnim->setPosition(CCPointMake(winsize.width/2 - 400, winsize.height/2 - 255));
    dogAnim->setScale(1.4);
...
void BBMatchGamePlay::shineAnimation(BBMGSprite *Sprite) {
    ...
    selectedSprite->setPosition(ccp(Sprite->getPositionX(), Sprite->getPositionY()));
}
...
void BBMatchGamePlay::checkCards() {
    ...
    if(this->firstSelectedSprite->matchID == this->secondSelectedSprite->matchID)
    {
        ...
        CocosDenshion::SimpleAudioEngine::sharedEngine()->playEffect(this->firstSelectedSprite->matchSoundName);
...
void BBMatchGamePlay::dogAnimation(const char *dogName) {
    ...
    animationDog->setRestoreOriginalFrame(1);
...
void BBMatchGamePlay::gameOver() {
    ...
    //dogClapping Sound
    CocosDenshion::SimpleAudioEngine::sharedEngine()->playEffect("clapping.mp3");
...
void BBMatchGamePlay::gotoLevel(cocos2d::CCMenuItemImage *sender) {
    ...
    switch (tag)
    {
        ...
        case 5: CCDirector::sharedDirector()->replaceScene(BBMatchGamePlay::scene());
