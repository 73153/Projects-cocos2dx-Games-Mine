...
EndScene::init()
{
	...
	__pFinalScoreLabel = CCLabelTTF::labelWithString("Final score: 0!", "Arial", 50);
	__pFinalScoreLabel->setPosition( ccp(winSize.width / 2, winSize.height - 20) );
	this->addChild(__pFinalScoreLabel, 1);

	// Create restart button.
	CCMenuItemFont* pRestartButton = CCMenuItemFont::itemFromString(
										"Restart",
										this,
	...
	CCMenu* pMenu = CCMenu::menuWithItems(pRestartButton, pCloseItem, NULL);
