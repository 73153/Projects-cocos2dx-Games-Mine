...
BBGameSelection::BBGameSelection()
{
    ...
    //match label
    CCLabelTTF *matchLAbel=CCLabelTTF::create("Match", "Noteworthy - 150pt - bold", 35);
    matchLAbel->cocos2d::CCNode::setPosition(CCPointMake(winsize.width/2-200, winsize.height/2+170));
    this->addChild(matchLAbel,2);
    //ticTac label
    CCLabelTTF *ticTacToeLAbel=CCLabelTTF::create("Tic Tac Toe", "Noteworthy - 150pt - bold", 35);
